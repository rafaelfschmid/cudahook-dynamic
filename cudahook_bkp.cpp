...
cudaError_t cudaFuncGetAttributes(struct cudaFuncAttributes *attr, const void *func){
  ...
  if (realCudaFuncGetAttributes == NULL)
    realCudaFuncGetAttributes = (cudaFuncGetAttributes_t)dlsym(RTLD_NEXT,"cudaFuncGetAttributes");
...
cudaError_t cudaGetDeviceProperties(struct cudaDeviceProp *prop, int device) {
	...
	printf("#$$$$$$####GetDeviceProperties ATRIBUTE\n");
  ...
  return realCudaGetDeviceProperties(prop, device);
}
